...
class IntegrationTagTest extends TaggableCachePoolTest
{
    ...
    public function testClientPrefixKeepsTagMembersUsable()
    {
        $client = new Client('tcp://127.0.0.1:6379', ['prefix' => 'issue-131:']);
    ...
    {
        $pool = new InspectablePredisCachePool($this->getClient());
...
final class InspectablePredisCachePool extends PredisCachePool
{
